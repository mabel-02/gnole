...
class Hemisphere2 : public Observable
{
public:
  /// constructor
  Hemisphere2(double delta_rap, double p, int nbin = 100, double maxlnkt = lnktmax, double maxt = EVOLCUT)
      : Observable(p, nbin, maxlnkt, maxt), delta_rap_(delta_rap) {}
